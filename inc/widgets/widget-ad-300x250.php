 ...
 * Register the Widget
 */
add_action( 'widgets_init', create_function( '', 'return register_widget( "EmPress_Lite_Ad_300x250" );') );

class EmPress_Lite_Ad_300x250 extends WP_Widget{
	
	public function __construct(){
		$widget_ops = array( /* Basically takes class name and description */
			'classname' => 'ad_300x250',
			'description' => __( 'Widget that displays 300x250 advertisement typically in the sidebar area.', 'empress-lite' )
			);
		...
		parent::__construct( 'ad_300x250_ID' /* Widget ID */, __( 'EmPress Lite - 300x250 Advertisement', 'empress-lite' ) /* Name of Widget */, $widget_ops, $control_ops );
	...
	*/
        ...
        <div class="advertisement_300x250">
            ...
            <?php }
                ...
                if ( !empty( $imageUrl ) ) {
                    ...
                    if ( !empty( $imageLink ) ) {
                        $output .= '<a href="'. $imageLink .'" target="_blank" ><img src="'. $imageUrl .'" alt="'. $imageLink .'" style="max-width: 300px; height: 250px" />';
                    } else {
                        $output .= '<img src="'. $imageUrl .'" style="max-width: 300px; height: 250px" />';
                    }
	...
	public function form( $instance ){
        ...
        <label><?php _e( 'Add your Advertisement 300x250 image here', 'empress-lite' ); ?></label>
        <p>
